...
public class AirPlane {
    public static void main(String[] args) throws Exception {
        ...
        flights.add(new Flight("İstanbul - Düzce", "13.01.2024", 50,200));
        flights.add(new Flight("İstanbul - BosnaHersek", "23.02.2024", 50,300));
        flights.add(new Flight("İstanbul - Gaziantep", "19.12.2025", 50,400));
        flights.add(new Flight("İstanbul - İzmir", "18.03.2024", 50,500));
        flights.add(new Flight("İstanbul - Rize", "04.02.2024", 50,600));
            ...
            switch (fchoose) {
                ...
                if (choice != 0 && choice >= 1 && choice <= flights.size()) {
                    ...
                    if (total >= 0) {
                        ...
                        if(seatNumber > 50){
                        System.out.println("Only 50 seats in airplane. You cannot make this reservation.");
                    ...
                    break;
                case 3:
                    ReservationCheck.printSelectedFlights(selectedFlights, user1);
                    break;
                case 4:
